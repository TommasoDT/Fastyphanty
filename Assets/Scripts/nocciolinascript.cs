...
public class nocciolinascript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        { 
            ...
            Tools.generalData.MoneteRaccolte++;//incrementa il contatore delle monete
            //GameObject.Find("Spawner").GetComponent<CollectObSpawner>().reached=true;//setta a true una variabile dello spawner
            car.transform.GetChild(1).GetComponent<AudioSource>().Play();
